...
function buildSystemPrompt(sources: CaseLawSource[]): string {
  ...
  return `You are a legal drafting assistant for TruDocket. You generate structured motion drafts to assist pro se users and small firms.
...
⚠ DISCLAIMER: This document was generated by TruDocket as a
